# binary_trees
# Team Project
 this project is suppose to be done in team of two or three but i choose to  approach the project by myself due to  my past Experience how neglet some team member can be.
